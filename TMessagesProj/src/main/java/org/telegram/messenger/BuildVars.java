...
public class BuildVars {
    ...
    public static boolean PREMIUM_DISABLED = true;
    ...
    public static boolean useInvoiceBilling() {
        return PREMIUM_DISABLED || BillingController.billingClientEmpty || DEBUG_VERSION || isStandaloneApp() || isBetaApp() || isHuaweiStoreApp() || hasDirectCurrency();
    }
