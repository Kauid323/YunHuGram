            ...
            AndroidUtilities.runOnUIThread(() -> {
                try {
                    if (finalError == ERROR_TYPE_UNSUPPORTED) {
                        ...
                        NotificationCenter.getGlobalInstance().postNotificationName(NotificationCenter.showBulletin, Bulletin.TYPE_ERROR, LocaleController.getString("FileUploadLimit", R.string.FileUploadLimit));
                    }
                } catch (Exception e) {
                    FileLog.e(e);
                }
