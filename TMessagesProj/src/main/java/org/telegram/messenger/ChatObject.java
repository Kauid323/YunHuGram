...
//        }
        ...
        public void migrateToChat(TLRPC.Chat chat) {
            ...
            if (callService != null && callService.getAccount() == currentAccount.getCurrentAccount() && callService.getChat() != null && callService.getChat().id == -chatId) {
                callService.migrateToChat(chat);
            }
        }
        ...
        private void setParticiapantsVolume() {
            CallService callService = CallService.getSharedInstance();
            if (callService != null && callService.getAccount() == currentAccount.getCurrentAccount() && callService.getChat() != null && callService.getChat().id == -chatId) {
                callService.setParticipantsVolume();
            }
        }
        ...
        public static boolean videoIsActive(TLRPC.TL_groupCallParticipant participant, boolean presentation, ChatObject.Call call) {
            ...
            if (participant.self) {
                return service.getVideoState(presentation) == CallConfig.VIDEO_STATE_ACTIVE;
            } else {
        ...
        public void sortParticipants() {
            ...
            CallService callService = CallService.getSharedInstance();
            if (callService != null && callService.groupCall == this) {
                if (callService.getVideoState(false) == CallConfig.VIDEO_STATE_ACTIVE || callService.getVideoState(true) == CallConfig.VIDEO_STATE_ACTIVE) {
                            activeVideos--;
                        }
                    }
                }
        ...
        public boolean canRecordVideo() {
            ...
            CallService callService = CallService.getSharedInstance();
            if (callService != null && callService.groupCall == this && (callService.getVideoState(false) == CallConfig.VIDEO_STATE_ACTIVE || callService.getVideoState(true) == CallConfig.VIDEO_STATE_ACTIVE)) {
                return true;
            }
