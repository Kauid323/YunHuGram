...
public class FragmentContextViewWavesDrawable {
    ...
    private void setState(int state, boolean animated) {
        ...
        if (CallService.getSharedInstance() == null && currentState == null) {
    ...
    public void updateState(boolean animated) {
        ...
        if (callService != null) {
            ...
            if (!callService.isSwitchingStream() && (currentCallState == CallService.STATE_WAIT_INIT || currentCallState == CallService.STATE_WAIT_INIT_ACK || currentCallState == CallService.STATE_CREATING || currentCallState == CallService.STATE_RECONNECTING)) {
                ...
                if (callService.groupCall != null) {
                    ...
                    if (participant != null && !participant.can_self_unmute && participant.muted && !ChatObject.canManageCalls(callService.getChat()) || callService.groupCall.call.rtmp_stream) {
