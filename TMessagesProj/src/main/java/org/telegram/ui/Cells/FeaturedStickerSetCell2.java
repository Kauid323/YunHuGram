...
public class FeaturedStickerSetCell2 extends FrameLayout implements NotificationCenter.NotificationCenterDelegate {
    ...
    private final TextView unlockButton;
    ...
    public FeaturedStickerSetCell2(Context context, Theme.ResourcesProvider resourcesProvider) {
        ...
        unlockButton = new TextView(context);
        unlockButton.setGravity(Gravity.CENTER);
        unlockButton.setTextColor(Theme.getColor(Theme.key_featuredStickers_buttonText));
        unlockButton.setTextSize(TypedValue.COMPLEX_UNIT_DIP, 14);
        unlockButton.setTypeface(AndroidUtilities.getTypeface("fonts/rmedium.ttf"));
        unlockButton.setText(LocaleController.getString("Unlock", R.string.Unlock));
        unlockButton.setBackground(Theme.AdaptiveRipple.createRect(Theme.getColor(Theme.key_featuredStickers_addButton), Theme.getColor(Theme.key_featuredStickers_addButtonPressed), 4));
        unlockButton.setPadding(AndroidUtilities.dp(12), 0, AndroidUtilities.dp(12), 0);
        unlockButton.setOnClickListener(e -> onPremiumButtonClick());
